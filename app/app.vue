...
<template>
  <section class="container">
    <div class="sidebar">
      <SideMenu v-model:active="active" />
    </div>
    <div class="content">
      <SideContent v-model:active="active" />
    </div>
  </section>
</template>
...
:root {
  --color-blue-950: hsl(213, 96%, 18%);
  --color-purple-600: hsl(243, 100%, 62%);
  --color-blue-300: hsl(228, 100%, 84%);
